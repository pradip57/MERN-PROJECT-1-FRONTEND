const ProductListHomePage = () => {
  return (
    <>
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0 mt-4 py-2">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="pt-6">
              <div className="mb-4 flex items-center justify-between gap-4">
                <span className="me-2 rounded bg-teal-100 px-2.5 py-0.5 text-xs font-medium text-teal-800 dark:bg-teal-900 dark:text-teal-300">
                  {" "}
                  Up to 35% off{" "}
                </span>
        ...
        <div className="relative h-full w-full max-w-xl md:h-auto">
          <div className="relative rounded-lg bg-white shadow dark:bg-gray-800">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        readOnly
                        className="h-4 w-4 rounded border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-teal-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-teal-600"
                      />
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="col-span-2 flex items-center justify-between space-x-2">
                      <input
                        ...
                        min="0"
                        max="7000"
                        className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-teal-500 focus:ring-teal-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-teal-500 dark:focus:ring-teal-500 "
                        placeholder=""
                        required
                      />
                    ...
                    <li className="w-full border-r border-gray-200 dark:border-gray-600">
                      <div className="flex items-center pl-3">
                        <input
                          ...
                          name="list-radio"
                          checked={true}
                          className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-teal-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-teal-600"
                        />
                        <label
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center">
                        ...
                        >
                          <div className="mr-2 h-3.5 w-3.5 rounded-full bg-teal-600"></div>
                          Blue
                        </label>
                      </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center">
                        <input
                          ...
                          readOnly
                          name="rating"
                          className="h-4 w-4 border-gray-300 bg-gray-100 text-teal-600 focus:ring-2 focus:ring-teal-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-teal-600"
                        />
                        <label
                          htmlFor="five-stars"
                  ...
                  <ul className="grid grid-cols-2 gap-4">
                    <li>
                      ...
                      <label
                        ...
                        className="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked={true} readOnly:border-teal-600 peer-checked={true} readOnly:text-teal-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked={true} readOnly:text-teal-500 md:p-5"
                      >
                        <div className="block">
            ...
            <div className="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
              <button
                type="submit"
                className="rounded-lg bg-teal-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-teal-800 focus:outline-none focus:ring-4 focus:ring-teal-300 dark:bg-teal-700 dark:hover:bg-teal-800 dark:focus:ring-teal-800"
              >
                Show 50 results
              </button>
              <button
                type="reset"
                className="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-teal-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700"
              >
                Reset
              </button>
            </div>
